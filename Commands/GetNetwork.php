...
namespace Piwik\Plugins\CustomGeoIP\Commands;
 ...
 */
class GetNetwork extends ConsoleCommand
{
    /**
    ...
    {
        $this->setName('customgeoip:get-network');
        $this->setDescription('GetNetwork');
        $this->addOption('ipAddress', null, InputOption::VALUE_REQUIRED, 'IP Address:');
    }
     ...
     *
     * Execute the command like: ./console customgeoip:get-network --name="The Piwik Team"
     */
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $name = $input->getOption('ipAddress');

        $message = sprintf('<info>GetNetwork: %s</info>', $name);
